<template>
  <div class="edit-page">
    ...
    <div class="form-card">
      <h1 class="page-title">Edit Cooperative</h1>
      ...
      <form @submit.prevent="handleSave">
        ...
        <section class="form-section">
          ...
          <div class="field full">
            ...
            <input v-model="form.name" type="text" class="field-input" placeholder="Green Valley Farmers Association" />
          ...
          <div class="field-row">
            <div class="field">
              ...
              <input v-model="form.registrationNumber" type="text" class="field-input" placeholder="REG-2019-0315-GH" />
          ...
          <div class="field full">
            ...
            <input v-model="form.primaryCrops" type="text" class="field-input" placeholder="Maize, Beans" />
        ...
        <section class="form-section">
          ...
          <div class="field-row">
            <div class="field">
              ...
              <input v-model="form.region" type="text" class="field-input" placeholder="Eastern Region" />
              <span v-if="errors.region" class="field-error">{{ errors.region }}</span>
            </div>
            <div class="field">
              <label class="field-label">District</label>
              <input v-model="form.district" type="text" class="field-input" placeholder="Koforidua District" />
            </div>
          </div>

          <div class="field full">
            <label class="field-label">Physical Address</label>
            <input v-model="form.address" type="text" class="field-input" placeholder="Enter complete physical address" />
          </div>
        </section>
        ...
        <section class="form-section">
          ...
          <div class="field-row">
            <div class="field">
              ...
              <input v-model="form.phone" type="tel" class="field-input" placeholder="+233 24 555 0001" />
              <span v-if="errors.phone" class="field-error">{{ errors.phone }}</span>
            </div>
            <div class="field">
              <label class="field-label">Email Address <span class="required">*</span></label>
              <input v-model="form.email" type="email" class="field-input" placeholder="info@greenvalley.coop" />
        ...
        <section class="form-section">
          ...
          <div class="field-row">
            <div class="field">
              ...
              <input v-model="form.chairperson" type="text" class="field-input" placeholder="Kwabena Frimpong" />
            ...
            <div class="field">
              ...
              <input v-model="form.secretary" type="text" class="field-input" placeholder="Beatrice Asare" />
        ...
        <section class="form-section">
          ...
          <div class="field-row">
            <div class="field">
              ...
              <input v-model="form.bank" type="text" class="field-input" placeholder="Agricultural Development Bank" />
            ...
            <div class="field">
              ...
              <input v-model="form.accountNumber" type="text" class="field-input" placeholder="ACC-1234567890" />
